...
♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣♣
	...
	tiles := parseMap(mapArt)
	return WorldMap{
		Name: "Viridian Forest", Width: getMapWidth(tiles),
		Height: len(tiles), Tiles: tiles,
		StartX: 18, StartY: 19, LocationID: 1,
		MinPokemonID: 10, MaxPokemonID: 30,
	}
}
...
■■■■■■■■■■■■■▓▓▓■■■■■■■■■■■■■■■■■■■■■■■
	...
	tiles := parseMap(mapArt)
	return WorldMap{
		Name: "Mt. Moon", Width: getMapWidth(tiles),
		Height: len(tiles), Tiles: tiles,
		StartX: 12, StartY: 14, LocationID: 2,
		MinPokemonID: 35, MaxPokemonID: 75,
	}
}
...
▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓
	...
	tiles := parseMap(mapArt)
	return WorldMap{
		Name: "Route 1", Width: getMapWidth(tiles),
		Height: len(tiles), Tiles: tiles,
		StartX: 12, StartY: 19, LocationID: 3,
		MinPokemonID: 16, MaxPokemonID: 50,
	}
}
...
═══════════════════════════════════════════
	...
	tiles := parseMap(mapArt)
	return WorldMap{
		Name: "Safari Zone", Width: getMapWidth(tiles),
		Height: len(tiles), Tiles: tiles,
		StartX: 16, StartY: 19, LocationID: 4,
		MinPokemonID: 100, MaxPokemonID: 150,
	}
}
